...
*Rendering equation* en inglés. Propuesta por Kajiya `r AutoCite(bib, "kajiya")`.
...
- $H^2(\mathbf{n})$: Conjunto de direcciones $\omega$ posibles. Hemisferio superior de la esfera $\mathbb{S}^2$.

--

- $\cos\theta_i = \left \vert \omega_i \cdot \mathbf{n} \right \vert$, con $\mathbf{n}$ normal en $p$.
...
knitr::include_graphics("../img/05/Materiales difusos.png")
```
]
.pull-right[
Especular perfecto
```{r, echo = FALSE, out.width = "320px"}
knitr::include_graphics("../img/05/Materiales espejos.png")
```
]
---
...
El estimador funciona en cualquier dimensión `r AutoCite(bib, "pellacini-marschner-2017")`.
...
Programa que corre en la tarjeta gráfica `r AutoCite(bib, "Haines2019")`, `r AutoCite(bib, "Marrs2021")`.
