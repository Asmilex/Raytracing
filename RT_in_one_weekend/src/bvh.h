...
class BVH_node : public hittable {
    public:
        ...
        BVH_node(std::vector<shared_ptr<hittable>>& src_objects, int start, int end, double time0, double time1);
...
BVH_node::BVH_node(const std::vector<shared_ptr<hittable>>& src_objects, int start, int end, double time0, double time1) {
    ...
    if (    !left->bounding_box(time0, time1, box_left)
        ...
        std::cerr << "No hay una bounding box en el constructor de BVH\n";
    }
